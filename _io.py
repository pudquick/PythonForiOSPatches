...
# This circular dependency keeps me from being able to import these classes from _pyio directly.
# To avoid this problem, the code was simply copied and pasted into a new fake _io module.
# No guarantees are made on its completeness or correctness.
